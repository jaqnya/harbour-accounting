PROCEDURE src_menu_principal
    ...
    @ 06, 07 PROMPT ' 1. SISTEMA DE CONTABILIDAD '
    @ 12, 07 PROMPT ' 2. MODULO DE EMPRESAS      '
    @ 18, 07 PROMPT ' 3. RE-ORGANIZACION         '
    @ 06, 48 PROMPT ' 4. COPIA DE SEGURIDAD     '
    @ 12, 48 PROMPT ' 5. RECUPERACION DE DATOS  '
    @ 18, 48 PROMPT ' 0. SALIR DE ESTE MENU     '
